    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 d-flex align-items-center justify-content-center">
                <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-550">
                    <div class="text-center text-md-center mb-4 mt-md-0 d-flex">
                        <img src="{{ asset('images/brand/logo.png') }}" alt="" class="me-3" height="50" width="50">
                        <h1 class="mb-3 mt-2 h3">{{ __('7J Sign and Printing Services') }}</h1>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <span>Password must be minimum of 8 letters and must have speacial characters. </span>
